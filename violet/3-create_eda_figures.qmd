---
title: "VIOLET: EDA Figures"
---

This file creates exploratory data visualizations for the VIOLET dataset.
...
df_forward <- read_parquet("derived_data/violet_death_carried_forward.parquet")
```
...
color_fill_scale <- c('#fed976','#fd8d3c', '#e31a1c', '#000000')
